...
export const SingleBlob = () => {
	return (
		<div className="absolute left-0 top-0 z-[10] h-full w-full overflow-y-visible">
			<svg
				viewBox="0 0 500 500"
				xmlns="http://www.w3.org/2000/svg"
				className="absolute bottom-[30%] right-[68%] scale-[2.5] max-sm:bottom-[60%] max-sm:right-[40%] max-sm:scale-[3]"
			>
				<defs>
